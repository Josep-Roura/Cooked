...
const profileUpdateSchema = z.object({
  ...
  allergies_restrictions: z.array(z.string()).nullable().optional(),
  preferred_cuisine: z.string().nullable().optional(),
  cooking_time_preference: z.string().nullable().optional(),
  budget_preference: z.string().nullable().optional(),
  daily_schedule: z.string().nullable().optional(),
